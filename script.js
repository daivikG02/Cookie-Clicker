...
function myBuyChildren() {
  if (localStorage.getItem("score") >= 1 * buyammount && document.getElementById("name3").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("cps", Number(localStorage.getItem("cps")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));

    localStorage.setItem("score", localStorage.getItem("score") - 1 * buyammount);
...
function myBuyFactory() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name4").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("clicks", Number(localStorage.getItem("clicks")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
...
function myBuySkyscrapper() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name5").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("cps", Number(localStorage.getItem("cps")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
...
function myBuyGiga() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name6").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("clicks", Number(localStorage.getItem("clicks")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
...
function myBuyJet() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name7").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("cps", Number(localStorage.getItem("cps")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
...
function myBuyspaceship() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name8").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("clicks", Number(localStorage.getItem("clicks")) - 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
...
function myBuyTime() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name9").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("clicks", Number(localStorage.getItem("clicks")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
...
function myBuyAI() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name10").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("cps", Number(localStorage.getItem("cps")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
...
function myBuyalien() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name11").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("cps", Number(localStorage.getItem("cps")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
...
function myBuyANTI() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name12").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("clicks", Number(localStorage.getItem("clicks")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
...
function myBuyConv() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name13").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("cps", Number(localStorage.getItem("cps")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
...
function myBuyfrac() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name14").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("clicks", Number(localStorage.getItem("clicks")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
...
function myBuyFgiga() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name15").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("clicks", Number(localStorage.getItem("clicks")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
...
function myBuyjava() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name16").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("cps", Number(localStorage.getItem("cps")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
...
function myBuyuni() {
  if (localStorage.getItem("score") >= 1 * buyammount & document.getElementById("name17").innerHTML != "?????" + "\n" + "(???)") {
    localStorage.setItem("cps", Number(localStorage.getItem("cps")) + 1 * buyammount * (1 + (localStorage.getItem("multi") / 100)));
